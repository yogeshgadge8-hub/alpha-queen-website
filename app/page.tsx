...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><div><button className="logo logo--footer">ALPHA QUEEN<span>cosmetics</span></button><p>Your focused online destination for everyday cosmetics.</p><div className="socials"><button>ig</button><button>yt</button><button>f</button></div></div><div><b>SHOP</b><a href="#shop">Body wash</a><a href="#shop">Body scrub</a><a href="#shop">Face care</a><a href="#shop">Gift sets</a></div><div><b>HELP</b><a href="#help">Contact us</a><a href="#help">Shipping policy</a><a href="#help">FAQs</a><a href="#help">Track order</a></div><div><b>ABOUT</b><a href="#story">Our story</a><a href="#story">Ingredients</a><a href="#story">Why Alpha Queen</a><a href="/admin/orders">Order desk</a></div><div className="footer-contact"><b>NEED HELP?</b><p>Mon–Sat, 10am–6pm IST</p><a href="mailto:care@alphaqueenofficial.com">care@alphaqueenofficial.com</a></div></footer>
      <div className="legal"><span>© 2026 Alpha Queen. Preview storefront.</span><span>Privacy · Terms · Shipping</span><span>alphaqueenofficial.com</span></div>
