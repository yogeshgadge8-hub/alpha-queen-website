...
export default function Home() {
  ...
  const submitReview = async (event: FormEvent) => {
    ...
    if (response.ok) setReview({ orderId: "", mobile: "", customerName: "", rating: "5", title: "", text: "", mediaUrl: "" });
