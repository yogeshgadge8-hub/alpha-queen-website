...
export default function OrdersPage() {
  ...
  return (
    <main className="orders-page">
      ...
      <section className="orders-alert"><b>LOCAL PREVIEW</b><span>WhatsApp/Instagram automatic import जोडलेले नाही. खाली social order manually add करा. Live करण्याआधी admin login आणि Meta Business API जोडणे आवश्यक आहे.</span></section>
