...
export default function OrdersPage() {
  ...
  return (
    <main className="orders-page">
      <header className="orders-header"><div><a href="/" className="orders-logo">ALPHA QUEEN<span>order desk</span></a><p>Website, Instagram आणि WhatsApp orders एकाच ठिकाणी.</p></div><div><a href="/admin/catalog">Stock & reviews</a><a href="/profit-calculator">Profit calculator</a><a href="/">View store</a></div></header>
